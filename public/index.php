...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
    <a class="navbar-brand js-scroll-trigger" href="#page-top">
      <span class="d-block d-lg-none">Asyraf Arifin</span>
      ...
      <div class="w-100">
        ...
        <div class="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
          <div class="resume-content">
            ...
            <div class="subheading mb-3">UiTM Jasin</div>
            <p>Being the top student, scoring A+ and A for every programming courses. Always the spotlight in presentations and group projects. Also served as the President of Language Society, Webmaster and committee for the annual Capture the Flag competition, Vice Project Leader for Kidney Fund Run program collaborated with Melaka Hospital.</p>
          </div>
